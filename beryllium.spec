...
Requires: gstreamer-0_10-plugins-ffmpeg >= 0.10.10, gnonlin >= 0.10.17
Requires: libgstreamer-0_10-0 >= 0.10.31, libqt4 >= 4.7.0, libQtGLib-2_0-0
Requires: libQtGStreamer-0_10-0, libstdc++6 >= 4.4.0
