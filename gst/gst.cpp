...
bool GstApplyFixes()
{
    ...
    return gst_plugin_register_static(GST_VERSION_MAJOR, GST_VERSION_MINOR, "builtinmotioncells", "",
                                      gst_motion_cells_plugin_init, PRODUCT_VERSION_STR, "LGPL", "nullptr", "nullptr", "nullptr");
}
