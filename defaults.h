...
#define DEFAULT_DCMTK_CONFIG_FILE     QString()
#define DEFAULT_DCMTK_DEBUG_LEVEL     OFLogger::WARN_LOG_LEVEL
...
#define DEFAULT_GST_DEBUG_COLORED     false
#define DEFAULT_GST_DEBUG_FULL_TAGS   false
